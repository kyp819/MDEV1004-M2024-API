...
import { ProcessLogin, ProcessRegistration, ProcessesLogout } from '../Controllers/auth';

//List of Authentation Roots
...
//Logout User
router.get('/logout', (req,res,next)=>{ ProcessesLogout(req,res,next);});
/* List of Routes (endpoints) */

/* GET Movie Roots List. */
